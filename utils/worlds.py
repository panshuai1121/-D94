...
class SD:
    ...
    def translate_in(self,language):
        words = {}
        words["English"] = "in"
        words["Chinese"] = "在"
        words["Dutch"] = "in"
    ...
    def translate_assert(self,language):
        words = {}
    ...
    def translate_assert_text(self,language):
        words = {}
    ...
    def translate_assert_exact_text(self,language):
        words = {}
    ...
    def translate_assert_link_text(self,language):
        words = {}
    ...
    def translate_assert_attribute(self,language):
        words = {}
    ...
    def translate_assert_title(self,language):
        words = {}
    ...
    def translate_assert_no_404_errors(self,language):
        words = {}
    ...
    def translate_assert_no_js_errors(self,language):
        words = {}
